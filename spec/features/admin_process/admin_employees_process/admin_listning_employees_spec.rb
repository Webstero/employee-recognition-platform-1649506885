...
RSpec.describe 'Admin listing employee', type: :feature do
  ...
  it 'Success' do
    ...
    expect(page).to have_text employee.created_at.strftime('%F')
    expect(page).to have_text employee.updated_at.strftime('%F')
    ...
    expect(page).to have_text second_employee.created_at.strftime('%F')
    expect(page).to have_text second_employee.updated_at.strftime('%F')
  end
end
